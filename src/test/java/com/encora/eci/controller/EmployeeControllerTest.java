...
class EmployeeControllerTest {
    ...
    public void countryReport() throws JSONException {
        //Given
        CountryReport countryReport = new CountryReport(new HashMap<>(), new HashMap<>());
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(jo).isNotNull();
        assertThat(jo.get("countryReport")).isNotNull();
        assertThat(jo.get("stateReport")).isNotNull();
    }
    ...
    private Employee createEmployee(){
        return new Employee("corpo@email.com", "Juan", "Bauer", GenderTypes.Male, "Mexico", "Jalisco", 1);
    }

    private Address createAddress(){
        return new Address("Street", "1234", "55667");
    }
